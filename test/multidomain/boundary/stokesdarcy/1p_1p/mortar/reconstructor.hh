...
public:
    ...
    { DUNE_THROW(Dune::NotImplemented, "Stress recovery for staggered"); }

    /*!
     * \brief TODO doc me.
     */
    template<class MortarSolutionVector>
    static MortarSolutionVector recoverSolution(const GridGeometry& gridGeometry,
                                                const GridVariables& gridVariables,
                                                const SolutionVector& sol,
                                                const ElementScvfIndexMap& map)
    {
...
public:
    ...
    recoverSolution(const GridGeometry& gridGeometry,
                    const GridVariables& gridVariables,
                    const SolutionVector& sol,
                    const ElementScvfIndexMap& map)
    {
