...
int main(int argc, char** argv) try
{
    ...
    const auto stokesAnalyticalSolution = createStokesAnalyticalSolution(0.0 /*time*/, *stokesProblem);
    ...
    const auto darcyAnalyticalSolution = createDarcyAnalyticalSolution(0.0 /*time*/, *darcyProblem);
