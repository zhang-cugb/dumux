...
public:
    ...
    {
        FluxVariables fluxVars;
        return fluxVars.computeMomentumFlux(problem, element, scvf, fvGeometry, elemVolVars, elemFaceVars, elemFluxVarsCache.gridFluxVarsCache(), curSol);
    }
                                            ...
                                            const SolutionVector& curSol) const
    {
        ...
        if (scvf.boundary())
        {
            ...
            if (bcTypes.isNeumann(Indices::velocity(scvf.directionIndex())))
            {
                ...
                result += fluxVars.computeMomentumFlux(problem, element, scvf, fvGeometry, elemVolVars, elemFaceVars, elemFluxVarsCache.gridFluxVarsCache(), curSol);
            }
